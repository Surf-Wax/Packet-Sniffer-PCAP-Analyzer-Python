...
def main():
    ...
    for i in range(1,10000):
        ...
        if key in captureDict:      # If unique combo already exists in dictionary
            captureDict[key] += 1   # Add to occurance field

        else:                       # Else, 
            captureDict[key] = 1    # Add to dictionary with occurance 1
